...
import numpy as np
# I3D Source from https://github.com/piergiaj/pytorch-i3d
...
class NLBlockAtt(nn.Module):
    def __init__(self, in_channels, key_channels, query_channels, val_channels, inter_channels=None, mode='embedded', 
        ...
        """
        super(NLBlockAtt, self).__init__()
