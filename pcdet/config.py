...
Lcfg = EasyDict()
Lcfg.ROOT_DIR = (Path(__file__).resolve().parent / '../').resolve()
Lcfg.LOCAL_RANK = 0

Rcfg = EasyDict()
Rcfg.ROOT_DIR = (Path(__file__).resolve().parent / '../').resolve()
Rcfg.LOCAL_RANK = 0

RLcfg = EasyDict()
RLcfg.ROOT_DIR = (Path(__file__).resolve().parent / '../').resolve()
RLcfg.LOCAL_RANK = 0